...
class OptimizeRequest(BaseModel):
    ...
    z1_min: int = Field(22, ge=6, le=500)
    z1_max: int = Field(70, ge=6, le=500)
    m_min: float = Field(1.0, gt=0.0)
    m_max: float = Field(3.0, gt=0.0)
    b_min: float = Field(10.0, gt=0.0)
    b_max: float = Field(40.0, gt=0.0)
    x1_min: float = Field(0.0, ge=-2.0, le=2.0)
